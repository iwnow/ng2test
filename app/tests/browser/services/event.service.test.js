...
var event_service_1 = require('../../../source/browser/ts/services/event.service');
describe('Сервис сообщений между компонентами внутри браузера:', function () {
    var _service = new event_service_1.EventService();
    before(function () {
        _service = new event_service_1.EventService();
    });
